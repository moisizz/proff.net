...
<div class="element_information">
  ...
  <div class="element_values">
    <div>
      <?php echo link_to($portfolio['Room']['name'], 'room', array('id' => $portfolio['room_id']))?>	
    </div>
    ...
    <div><?php include_component('preorder', 'unitTransfer', array('id' => $portfolio['id'], 'unit_type' => 'portfolio')) ?></div>
  </div>
</div>
